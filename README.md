...
Basic app with a Rich Text Editor in the App Settings so that formatted text can be
added to a custom HTML app without having to write HTML.  

![screenshot](./images/screenshot.png "This is an example")

Caveats:  Links will not work directly from this page if they are not https because only
secure http calls are permitted from within the app.  In order to
open a link from the text in this page, choose the "Open in New Tab..." or Open in new
window option.   
